#
# spec file for package icinga_check_etcd
#

Name:           icinga_check_etcd
Version:        %{version}
Release:        %{release}
Summary:        Check etcd cluster members
License:        BSD
Group:          System/Monitoring
Url:            https://github.com/joernott/check_etcd
Source0:        https://github.com/joernott/check_etcd/releases/download/%{version}/check_etcd-%{version}.tar.gz
BuildArch:      noarch
Requires:       etcd
Requires:       curl
